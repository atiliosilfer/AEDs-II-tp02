/* TP02Q11 - Ordenacao Parcial por QuickSort
...
public class QuickSortParcial
{
  ...
  * */
  public QuickSortParcial (int tamanho)
  {
 ...
 * */
   public void ordemQuickSort (int esq, int dir, int k)
   {
      int i = esq, j = dir;
      ...
      if (j - esq >= k -1){
         if (esq < j) 
            ordemQuickSort (esq, j,k);
         return;
      }
      if (esq < j)
         ordemQuickSort (esq,j,k);
      if (i < dir)
         ordemQuickSort (i, dir,k);
   }//fim ordemSelecao
 ...
 //main
  public static void main (String [] args)
  {
   ...
   try {
    QuickSortParcial lista = new QuickSortParcial (200);
   //abrir arquivo
    FileWriter arquivo = new FileWriter ("628510_quicksort.txt");
   ...
   //ordenar lista
    lista.ordemQuickSort(0, (lista.getN ()-1), 10);
