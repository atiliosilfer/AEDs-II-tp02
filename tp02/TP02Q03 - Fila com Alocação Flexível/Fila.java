/* TP02Q03 - Fila com Alocacao Flexivel
...
public class Fila
{
   ...
   /*
  * Somar a media da despesa docente
  * @return int resp - Media arredondada das Despesas Docente das IES na fila
  * */
  public int somarMedia ()
  {
     //definir dados
      int resp;
      long media;
      double soma = 0;
      int controle = 0;
     //somar Despesas Docente de cada elemento na fila
      for (Instituicao i = primeiro.prox; i != null; i = i.prox){
        soma = soma + (i.getDespesaDocente ());
        controle++;
      }//fim while
      soma = soma/controle;
 ...
 //main
  public static void main (String [] args)
  {
   ...
   while (nlines > 0)
   {
    ...
    try { fila.inserir (instituicao.clone ());
   ...
   for (int i = 0; i < tamanho; i++)
   {
     ...
     if (comando.equals ("I"))
     {
      ...
      fila.inserir (instituicao.clone());
     }
