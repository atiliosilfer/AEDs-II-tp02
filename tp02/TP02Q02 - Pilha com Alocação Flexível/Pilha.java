/* TP02Q02 - Pilha com Alocacao Flexivel
...
/*
 * Pilha dinamica de Instituicoes
 * @author Atilio Silva Ferreira
 * @version 1 09/2018
 * */
public class Pilha
{
   private Instituicao topo;
    ...
    * */
    ...
    /**
    * Remove uma instituicao da pilha
    ...
    * */
      public Instituicao remover () throws Exception {
         ...
         Instituicao resp = topo.clone();
         Instituicao tmp = topo;
         topo = topo.prox;
         tmp.prox = null;
         tmp = null;
         return resp;
   ...
   /**
     * Chama metodo para mostrar as instituicao na pilha recursivamente
     */
    public void mostrar() {
          mostrarRec (topo);
    }//fim mostrar
   ...
   /**
     * Mostra as instituicoes recursivamente
     * @param i Instituicao comeco do processo
     */
    public void mostrarRec (Instituicao i){
      if (i != null){
       mostrarRec (i.prox);
       i.imprimir();
      }//fim if
