/* TP02Q10 - Ordenacao Parcial por HeapSort
...
public class HeapSortParcial{
  ...
  * */
  public HeapSortParcial (int tamanho){
 ...
 * */
   public void constroi (int tamHeap) {
      for (int i = tamHeap; i > 1 && array[i].getCodigoMunicipio() <= array[i/2].getCodigoMunicipio(); i = i/2) {
 ...
 * */
   public void ordemHeapSort (int k) {
  //alterar o vetor ignorando a posicao zero
      Instituicao [] tmp = new Instituicao [n+1];
      for (int i = 0; i < n; i++) {
        tmp [i+1] = array [i];
        movimentacoes++;
      }
 ...
 //main
  public static void main (String [] args)
  {
   ...
   try {
    HeapSortParcial lista = new HeapSortParcial (200);
   //abrir arquivo
    FileWriter arquivo = new FileWriter ("628510_heapsortParcial.txt");
